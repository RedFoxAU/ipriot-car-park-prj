...
| ---------- | ---------- | ------- |
| `CarPark`  | `location`, `capacity`, `plates`, `displays`, `log_file` | `register`, `add_car`, `remove_car`, `update_displays`, `available_bays (property)`, `_log_car_activity` |
| `Sensor`   | `id`, `is_active`, `car_park` | `_scan_plate`, `detect_vehicle`, `update_car_park (abstract)` |
